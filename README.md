...
A simple Console-Based Java Project built using JDBC and MySQL to perform full CRUD operations on student records.
This is simple project who enhance my skills to work with JDBC and gain my confidence.
